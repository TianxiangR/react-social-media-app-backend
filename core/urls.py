...
urlpatterns = [
    ...
    path('posts/<uuid:postId>/replies/', post_views.PostReplyListView.as_view()),
    ...
    path('users/<str:username>/followers/', user_views.UserFollowerListView.as_view()),
    path('users/<str:username>/following/', user_views.UserFollowingListView.as_view()),
    path('search/', search_views.SearchAPIView.as_view()),
    path('notifications/', notification_views.NotificationListView.as_view()),
    path('notifications/<uuid:notificationId>/', notification_views.NotificationView.as_view()),
    ...
    path('top-rated-range/', post_views.TopRatedPostRangeView.as_view()),
    path('following-posts/', post_views.FollowingPostListView.as_view()),
    path('following-posts-range/', post_views.FollowingPostRangeView.as_view()),
]