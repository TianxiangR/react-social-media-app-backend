...
urlpatterns = [
    ...
    path('search/top/', search_views.SearchTopView.as_view()),
    path('search/latest/', search_views.SearchLatestView.as_view()),
    path('search/people/', search_views.SearchPeopleView.as_view()),
    path('search/media/', search_views.SearchMediaView.as_view()),
    path('search/hashtags/', search_views.SearchHashtagView.as_view()),
    ...
    path('debug/user-input/', debug_views.UserInputView.as_view()),
